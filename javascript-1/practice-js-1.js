...
const trueOrFalse = (data) => data ? true : false;
...
console.log(oddChecker(faveNum))
...
console.log(iLove(myName, 'sandwiches'));
...
console.log(bigOrSmall([23, 345, 5432, 0, 99, 1234]));
...
console.log(arrayReverser([23, 345, 5432, 0, 99, 1234]));
